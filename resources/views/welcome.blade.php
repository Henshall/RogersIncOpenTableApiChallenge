            ...
            <div class="text-gray">
              <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                  ...
                  <input id="name" type="text" class="form-control" placeholder="Your first name" name="frname" value="{{ old('name') }}" >
                ...
                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                  ...
                  <input id="email" type="email" class="form-control" name="email" placeholder="you@example.com" value="{{ old('email') }}" >
                  @if ($errors->has('email'))
                    <span class="help-block">
