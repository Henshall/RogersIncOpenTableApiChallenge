    ...
    <div class="row">
      <div class="left">
        <ul>
          ...
          <li><a href="#faq-1"> What was the most useful feature that was added to the latest version of your chosen language? Please include a snippet of code that shows how you've used it.  </a></li>
          <li><a href="#faq-2"> How would you track down a performance issue in production? Have you ever had to do this?  </a></li>
