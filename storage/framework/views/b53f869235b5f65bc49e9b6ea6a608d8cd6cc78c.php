...
<body class="home domain-ca rush-1504-2 ">
  ...
  <style>
    ...
    .breadcrumb li.icon-visible a:before {
      font-family: icons;
      speak: none;
      font-style: normal;
      font-weight: 400;
    ...
    @mediaonly  screen and (min-width:64.0625em) {
      .breadcrumb {
        padding: 0 2.25rem
      }
    }
    ...
    .breadcrumb li.icon-visible a {
      display: block;
      width: 100%;
      height: 100%
    }

    .breadcrumb li.icon-visible a span {
      display: none
    }
    ...
    .domain-comau .top-bar-nav-link.icon-location {
      line-height: 55px
    }

    .domain-comau .top-bar-nav-link.icon-location:before {
      color: rgba(0, 0, 0, .12);
      font-size: 18px;
      position: relative;
      top: 4px;
    ...
    .domain-comau .with-location-picker .tab-bar-logo {
      margin-left: 48px
    }

    .domain-comau .hamburger-menu .top-bar-nav-link {
      line-height: 50px
    }

    .menu-drawer-left.sliding-menu .menu-close:after {
      font-family: icons;
      speak: none;
      font-style: normal;
      font-weight: 400;
    ...
    .menu-drawer-left.sliding-menu.menu-opened {
      background-color: rgba(0, 0, 0, .5);
      pointer-events: auto
    }

    .menu-drawer-left.sliding-menu.menu-opened:before {
      content: none
    }

    .menu-drawer-left.sliding-menu.menu-opened .menu-container {
      transform: translate3d(0, 0, 0)
    }

    .menu-drawer-left.sliding-menu .menu-container {
      width: 220px;
      height: 100%;
      max-height: initial;
    ...
    .menu-drawer-left.sliding-menu .menu-container .menu-main {
      border-radius: 0;
      box-shadow: none;
      width: 100%;
      height: 100%;
    ...
    .menu-drawer-left.sliding-menu .menu-list-link {
      transition: color .15s ease-out;
      font-size: .875rem;
      padding: .5rem 1rem .5rem 1.5rem
    }

    .menu-drawer-left.sliding-menu .menu-list-link-primary {
      color: #60b2d0 !important;
      border-bottom: 1px solid rgba(0, 0, 0, .08);
      font-size: 1rem;
      padding: .75rem 1rem .75rem 1.5rem
    }

    .menu-drawer-left.sliding-menu .menu-list-link-primary:hover {
      color: #356273 !important
    }

    .menu-drawer-left.sliding-menu .menu-list-link-primary.sign-out-link {
      color: #da3743 !important
    }

    .menu-drawer-left.sliding-menu .menu-list-link-primary.sign-out-link:hover {
      color: #811520 !important
    }

    .menu-drawer-left.sliding-menu .menu-list-link.help-link {
      margin-top: 3rem
    }

    .menu-drawer-left.sliding-menu .menu-close {
      position: absolute;
      top: 1rem;
      right: 1rem;
      z-index: 10;
    ...
    .menu-drawer-left.sliding-menu .menu-close:hover {
      color: #356273
    }
    ...
    #hamburger-pane .languageSelectorIcon,
    #hamburger-pane .languageSelectorLabel {
      display: inline
    }

    #hamburger-pane .language-selector .menu-main {
      box-shadow: none;
      margin: 0;
      border-radius: 0
    }

    #hamburger-pane .language-selector__link {
      float: none
    }

    #hamburger-pane .language-selector__link:after {
      right: 1rem
    }

    #hamburger-pane .language-selector .language-selector__link {
      display: none
    }

    #hamburger-pane .language-selector .language-selector__menu {
      position: relative;
      display: block
    }

    #hamburger-pane .language-selector .menu-container {
      opacity: 1;
      max-height: 100%;
      position: relative
    }
    ...
    .tab-bar .location-picker {
      left: 150px;
      margin-left: 0;
      right: auto
    }

    .tab-bar .location-picker .top-bar-nav-link {
      padding-left: .75rem
    }

    .tab-bar .location-picker a.icon-location {
      color: #999
    }

    .tab-bar .location-picker a.icon-location:before {
      margin-right: .3rem
    }

    .tab-bar .location-picker:after {
      content: "";
    ...
    .gpt-427 .menu-footer__actions {
      display: table;
      width: 100%
    }

    .gpt-427 .menu-footer__actions__right {
      display: table-cell;
      text-align: right
    }

    .gpt-427 .menu-footer__actions__left {
      display: table-cell
    }
    ...
    .utility-bar .language-selector__link,
    .utility-bar .top-bar-nav-link {
      height: 1.75rem;
      line-height: 1.75rem
    }

    .utility-bar .language-selector:after {
      content: none
    }

    .utility-bar .language-name,
    .utility-bar .top-bar-nav-link {
      color: #717171
    }

    .utility-bar .language-name:hover,
    .utility-bar .top-bar-nav-link:hover {
      color: #333
    }

    .utility-bar .language-selector .language-selector--main .language-icon {
      padding-top: 3px
    }

    .utility-bar .language-selector__link:after {
      right: .3rem
    }

    .utility-bar .top-bar-nav-link.with-arrow:after {
      right: 0
    }

    .utility-bar .top-bar-nav-link.with-arrow {
      padding-right: 1rem
    }

    .utility-bar section.top-bar-nav.utility-bar,
    body.platform-mobile .site-header {
      height: auto;
      min-height: auto
    }

    @mediaonly  screen and (min-width:48.0625rem) {
      .utility-bar .show-for-medium-2-up {
    ...
    @mediaonly  screen and (max-width:48rem) {
      .utility-bar .hide-for-medium-2-down {
        display: none !important
      }
    }

    @mediaonly  screen and (max-width:64em) and (min-width:40.0625em) {
      .utility-bar .top-bar-nav-link {
        padding: 0 1rem
      }
    }

    @mediaall  and (device-width:768px) and (device-height:1024px) and (orientation:landscape) {
      .top-bar.utility-bar {
        display: none !important
      }
    ...
    .top-bar-nav-link.without-right-padding {
      padding-right: 0
    }
    ...
    .language-selector__menu__list a.selected:after {
      font-family: icons;
      content: "x";
      display: block;
      position: absolute;
    ...
    .language-selector .language-selector--main .language-icon {
      padding-top: 5px;
      float: left
    }

    .language-selector .language-selector--main .language-name {
      float: left;
      display: block;
      padding-left: 5px
    }
    ...
    .iconLanguageSelector {
      background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg width=%2721px%27 height=%2721px%27 viewBox=%270 0 21 21%27 version=%271.1%27 xmlns=%27http://www.w3.org/2000/svg%27 xmlns:xlink=%27http://www.w3.org/1999/xlink%27%3E%3Cg stroke=%27none%27 stroke-width=%271%27 fill=%27none%27 fill-rule=%27evenodd%27 stroke-linecap=%27round%27 stroke-linejoin=%27round%27%3E%3Cg id=%27language-selector__icon%27 transform=%27translate(1.000000, 1.000000)%27 stroke=%27#999%27%3E%3Cpath d=%27M9.00033103,18.0001986 C4.02947095,18.0001986 0.000331034484,13.9710587 0.000331034484,9.00019862 C0.000331034484,4.02933853 4.02947095,0.00019862069 9.00033103,0.00019862069 C13.9705561,0.00019862069 18.000331,4.02933853 18.000331,9.00019862 C18.000331,13.9710587 13.9705561,18.0001986 9.00033103,18.0001986 Z%27 id=%27Stroke-1%27 stroke-width=%272%27%3E%3C/path%3E%3Cpath d=%27M12.6,9.00019862 C12.6,13.9710587 10.98809,18.0001986 8.999746,18.0001986 C7.01190997,18.0001986 5.4,13.9710587 5.4,9.00019862 C5.4,4.02933853 7.01190997,0.00019862069 8.999746,0.00019862069 C10.98809,0.00019862069 12.6,4.02933853 12.6,9.00019862 L12.6,9.00019862 Z%27 id=%27Stroke-3%27 stroke-width=%271.3%27%3E%3C/path%3E%3Cpath d=%27M0.887106207,6.78 L16.8,6.78%27 id=%27Stroke-5%27 stroke-width=%271.3%27%3E%3C/path%3E%3Cpath d=%27M0.887106207,11.58 L16.8,11.58%27 id=%27Stroke-7%27 stroke-width=%271.3%27%3E%3C/path%3E%3C/g%3E%3C/g%3E%3C/svg%3E");
      width: 21px;
      height: 21px;
      display: inline-block
    }

    .utility-bar .iconLanguageSelector {
      background-size: 100%;
      width: 16px;
      height: 18px;
    ...
    .header-search-box__container.visible {
      visibility: visible;
      opacity: 1;
      padding-bottom: 64px;
    ...
    .header-privacy-banner.hide {
      display: none
    }

    .header-privacy-banner__inner {
      display: flex;
      height: 70px;
      flex-direction: row;
    ...
    .header-privacy-banner__text a {
      color: #da3743
    }

    .header-privacy-banner__text a:hover {
      color: #b8222d;
      cursor: pointer
    }

    .header-privacy-banner__text a:visited {
      color: #b8222d
    }

    .header-privacy-banner__button {
      padding: 6px 18px;
      border-radius: 4px;
  ...
  <div id="hamburger-pane" class="hamburger-pane">
    <div class="hamburger-pane__header">
      <div class="top-bar show-for-medium-up">
        <ul class="hamburger-menu">
          <li class="top-bar-nav-li"></li><a href="#" data-target="hamburger-pane" class="top-bar-nav-link js-toggle-hamburger"><i class="icon-list font-size-medium"></i></a>
        </ul>
      </div>
      <div class="tab-bar hide-for-medium-up">
        <ul class="hamburger-menu">
          <li class="top-bar-nav-li"></li><a href="#" data-target="hamburger-pane" class="top-bar-nav-link js-toggle-hamburger"><i class="icon-list font-size-medium"></i></a>
        </ul>
      </div>
    </div>
    <div class="hamburger-pane__body">
      <ul class="hide-for-medium-up location-search-adjusted-hide-for-medium-up"><a
          href="/my/registerpopup?rp=https%3A%2F%2Fwww.opentable.ca%2F%3Fref%3D16276%26SP%3Dppc_g_ca_tm%26LS%3Dgglppc%26MID%3Dca_tm%26gclid%3DEAIaIQobChMI2vv60Mfu4QIVUAOGCh3rbQlPEAAYASAAEgI0VvD_BwE%26gclsrc%3Daw.ds&amp;srs=1" id="mobile_nav_sign_up"
          class="menu-list-link menu-list-link-primary">Sign up</a><a
          href="/my/loginpopup?rp=https%3A%2F%2Fwww.opentable.ca%2F%3Fref%3D16276%26SP%3Dppc_g_ca_tm%26LS%3Dgglppc%26MID%3Dca_tm%26gclid%3DEAIaIQobChMI2vv60Mfu4QIVUAOGCh3rbQlPEAAYASAAEgI0VvD_BwE%26gclsrc%3Daw.ds&amp;srs=1" id="mobile_nav_sign_in"
          title="Sign in" class="menu-list-link menu-list-link-primary">Sign in</a></ul>
      <div class="languageSelectorLink"><a href="#">
          <div class="languageSelectorIcon">
            <div class="iconLanguageSelector"></div>
          </div>
          <div class="languageSelectorLabel">Language</div>
        </a></div>
      <div class="language-selector"><a href="#" class="language-selector__link">
          <div class="language-icon">
            <div class="iconLanguageSelector"></div>
          </div>
        </a>
        <div class="language-selector__menu menu menu-right">
          <div class="menu-container">
            <div class="menu-main">
              <div class="menu-section">
                <div class="language-selector__menu__list menu-list-selectors"><a href="https://www.opentable.ca/start/home/?lang=de" data-lang="de" class="js-languages-list__link menu-list-link">Deutsch</a><a aria-selected="true"
                    href="https://www.opentable.ca/start/home/?lang=en" data-lang="en" class="js-languages-list__link menu-list-link  selected ">English</a><a href="https://www.opentable.ca/start/home/?lang=es" data-lang="es"
                    class="js-languages-list__link menu-list-link">Español</a><a href="https://www.opentable.ca/start/home/?lang=fr" data-lang="fr" class="js-languages-list__link menu-list-link">Français</a><a
                    href="https://www.opentable.ca/start/home/?lang=it" data-lang="it" class="js-languages-list__link menu-list-link">Italiano</a><a href="https://www.opentable.ca/start/home/?lang=nl" data-lang="nl"
                    class="js-languages-list__link menu-list-link">Nederlands</a><a href="https://www.opentable.ca/start/home/?lang=ja" data-lang="ja" class="js-languages-list__link menu-list-link">日本語</a></div>
              </div>
            </div>
          </div>
        </div>
      </div><a href="https://help.opentable.com/s/?language=en_CA" target="_blank" class="menu-list-link">Help</a><a href="https://opentable.tlnk.io/serve?action=click&amp;publisher_id=354660&amp;site_id=13216&amp;my_site=ca&amp;my_keyword=en"
        target="_blank" class="menu-list-link app-link">iOS App</a><a href="https://jjb-o.tlnk.io/serve?action=click&amp;publisher_id=354660&amp;site_id=13212&amp;my_site=ca&amp;my_keyword=en" target="_blank" class="menu-list-link app-link">Android
        App</a>
    </div>
  </div>
  <div id="hamburger-overlay" class="js-toggle-hamburger"></div>
  <div id="header" class="site-header">
    <div class="top-bar show-for-medium-up utility-bar">
      <section class="top-bar-nav show-for-medium-up utility-bar">
        <ul>
          <li class="top-bar-nav-li hide-for-medium-2-down"><a
              href="https://restaurant.opentable.ca/en/get-started/?utm_source=dinersite&amp;utm_medium=referral&amp;utm_campaign=topnav&amp;Lead.LeadSource=DinerSite&amp;Lead.Marketing_ID__c=topnav_CA" target="_blank"
              onClick="window.forRestaurateursLink.onClick();return false;" class="top-bar-nav-link without-right-padding">For Restaurateurs</a></li>
          <li class="top-bar-nav-li hide-for-xsmall-only hide-for-small-only hide-for-medium-only show-for-medium-2-up"><a href="#" data-target="header-mobile-menu" class="top-bar-nav-link js-toggle-menu with-arrow">Mobile</a>
            <div id="header-mobile-menu" class="menu menu-right">
              <div class="menu-container">
                <div class="menu-main">
                  <div class="menu-section">
                    <div class="menu-list"><a href="https://opentable.tlnk.io/serve?action=click&amp;publisher_id=354660&amp;site_id=13216&amp;my_site=ca&amp;my_keyword=en" target="_blank" class="menu-list-link app-link">iOS App</a><a
                        href="https://jjb-o.tlnk.io/serve?action=click&amp;publisher_id=354660&amp;site_id=13212&amp;my_site=ca&amp;my_keyword=en" target="_blank" class="menu-list-link app-link">Android App</a></div>
                  </div>
                </div>
              </div>
            </div>
          </li>
          <li class="top-bar-nav-li hide-for-medium-2-down"><a href="https://help.opentable.com/s/?language=en_CA" target="_blank" class="top-bar-nav-link">Help</a></li>
          <li class="top-bar-nav-li hide-for-medium-2-down"></li>
          <li class="top-bar-nav-li hide-for-xsmall-only hide-for-small-only hide-for-medium-2-down">
            <div class="language-selector"><a href="#" class="language-selector__link js-toggle-menu language-selector--main">
                <div>
                  <div class="language-icon">
                    <div class="iconLanguageSelector"></div>
                  </div>
              ...
              <div class="js-language-selector__menu language-selector__menu menu menu-right menu-target">
                <div class="menu-container">
                  <div class="menu-main">
                    <div class="menu-section">
                      <div class="language-selector__menu__list menu-list-selectors"><a href="https://www.opentable.ca/start/home/?lang=de" data-lang="de" class="js-languages-list__link menu-list-link">Deutsch</a><a aria-selected="true"
    ...
    <div class="top-bar show-for-medium-up">
      <div class="top-bar-logo"><a href="/start/home" class="top-bar-logo-link">
          <div class="top-bar-logo-name">OpenTable</div>
        </a></div>
      <nav id="location-picker" role="navigation" class="location-picker"><a href="#" data-target="location-menu" id="location-picker-link" class="location-picker-link js-toggle-menu">
          <div class="location-picker-metro light">Choose your location</div>
        </a>
          ...
          <div class="menu-container">
            <div class="menu-main">
              <div class="menu-header">
                <div class="row">
                  <div class="column small-4 location-picker-menu-country-header location-picker-menu-header hide">Country</div>
                  <div class="column small-6 location-picker-menu-header">Location</div>
                  <div class="column small-6 location-picker-menu-header">Region</div>
                </div>
              </div>
              <div class="menu-body">
                <div class="location-picker-menu-column location-picker-menu-country-column menu-section js-lionbars hide">
                  <div id="location-picker-country-list" class="location-picker-menu-list menu-list menu-list-selectors with-arrows"></div>
                </div>
                <div class="location-picker-menu-column menu-section js-lionbars">
                  <div id="location-picker-metro-list" class="location-picker-menu-list menu-list menu-list-selectors with-arrows"><a href="/montreal-restaurants" data-metro="75" class="menu-list-link selected">Montreal / Quebec</a><a
                      href="/toronto-restaurants" data-metro="74" class="menu-list-link">Toronto</a><a href="/vancouver-restaurants" data-metro="73" class="menu-list-link">Vancouver</a></div>
                </div>
                <div class="location-picker-menu-column menu-section js-lionbars">
                  <div id="city-list" class="location-picker-menu-list menu-list menu-list-selectors with-meta"><a href="/montreal-restaurants" data-macro="0" class="menu-list-link selected">All Montreal / Quebec<span
                        class="menu-list-link-meta">3955</span></a><a href="/i/montreal/montreal-restaurants" data-macro='166' class="menu-list-link">Montreal<span class="menu-list-link-meta">1953</span></a><a
                      href="/g/montreal/quebec-city-trois-rivieres-restaurants" data-macro='1540' class="menu-list-link">Quebec City / Trois-Rivieres<span class="menu-list-link-meta">459</span></a><a href="/g/montreal/laval-restaurants"
                      data-macro='2110' class="menu-list-link">Laval<span class="menu-list-link-meta">164</span></a><a href="/g/montreal/south-shore-restaurants" data-macro='1720' class="menu-list-link">South Shore<span
                        class="menu-list-link-meta">172</span></a><a href="/g/montreal/saguenay-lac-saint-jean-restaurants" data-macro='2113' class="menu-list-link">Saguenay–Lac-Saint-Jean<span class="menu-list-link-meta">136</span></a><a
                      href="/g/montreal/eastern-townships-restaurants" data-macro='2119' class="menu-list-link">Eastern Townships<span class="menu-list-link-meta">358</span></a><a href="/g/montreal/the-laurentians-restaurants" data-macro='2548'
                      class="menu-list-link">The Laurentians<span class="menu-list-link-meta">349</span></a><a href="/g/montreal/ormstown-restaurants" data-macro='2551' class="menu-list-link">Ormstown<span class="menu-list-link-meta">6</span></a><a
                      href="/montreal-restaurants?mn=3259" data-macro='3259' class="menu-list-link">Bas-Saint-Laurent<span class="menu-list-link-meta">1</span></a><a href="/montreal-restaurants?mn=3007" data-macro='3007'
                      class="menu-list-link">Gatineau<span class="menu-list-link-meta">97</span></a><a href="/g/montreal/ile-perrot-hudson-restaurants" data-macro='2740' class="menu-list-link">Ile Perrot / Hudson<span
                        class="menu-list-link-meta">61</span></a><a href="/g/montreal/lanaudiere-restaurants" data-macro='2599' class="menu-list-link">Lanaudiere<span class="menu-list-link-meta">128</span></a><a
                      href="/g/montreal/western-quebec-restaurants" data-macro='3064' class="menu-list-link">Western Quebec<span class="menu-list-link-meta">71</span></a></div>
                </div>
              </div>
              <div class="menu-footer"><a href="/start/home" class="secondary">Full List of Locations</a></div>
            </div>
          </div>
        </div>
      </nav>
      <section class="top-bar-nav show-for-medium-up">
        <ul>
          <li id="recently-viewed" class="top-bar-nav-li top-bar-nav-recently-viewed hide location-search-adjusted-show-for-medium-up"></li>
          <li class="top-bar-nav-li has-button location-search-adjusted-show-for-medium-up"><a
              href="/my/registerpopup?rp=https%3A%2F%2Fwww.opentable.ca%2F%3Fref%3D16276%26SP%3Dppc_g_ca_tm%26LS%3Dgglppc%26MID%3Dca_tm%26gclid%3DEAIaIQobChMI2vv60Mfu4QIVUAOGCh3rbQlPEAAYASAAEgI0VvD_BwE%26gclsrc%3Daw.ds&amp;srs=1"
              data-modal-trigger="register" data-modal-trigger-overrides='{"useElementHref": true}' class="top-bar-nav-button button small secondary" id="global_nav_sign_up" title="">Sign up</a></li>
          <li class="top-bar-nav-li location-search-adjusted-show-for-medium-up"><a href="" data-modal-trigger="login" data-modal-trigger-overrides='{"useElementHref": true}' class="top-bar-nav-link" id="global_nav_sign_in" title="Sign in">Sign
              in</a></li>
          <li class="top-bar-nav-li hamburger-menu hide-for-medium-2-up"><a href="#" data-target="hamburger-pane" class="top-bar-nav-link js-toggle-hamburger"><i class="icon-list font-size-medium"></i></a></li>
        </ul>
      </section>
    </div>
    <div class="tab-bar hide-for-medium-up">
      <div class="tab-bar-logo"><a href="/start/home" data-target="mobile-menu" class="top-bar-logo-small-link js-toggle-menu">
          <div class="top-bar-logo-name">OpenTable</div>
        </a></div>
      <section class="top-bar-nav new-hamburger">
        <ul>
          <li class="top-bar-nav-li hamburger-menu hide-for-large-only"><a href="#" data-target="hamburger-pane" class="top-bar-nav-link js-toggle-hamburger"><i class="icon-list font-size-medium"></i></a></li>
        </ul>
      </section>
    </div>
    <div role="banner" class="header-privacy-banner hide">
      <div class="header-privacy-banner__inner">
        <div class="header-privacy-banner__text"></div>
      </div>
      <script>
        $(".header-privacy-banner__button").click(function() {
          OT.Common.Cookies.set({
            "oc-updated-privacy-banner": !0
          }, 432e6), $(".header-privacy-banner").addClass("hide")
        }), $().ready(function() {
          window.location.href.toLowerCase().includes("/my/login") || "true" === OT.Common.Cookies.get("oc-updated-privacy-banner") || $(".header-privacy-banner").removeClass("hide")
        });
      </script>
    </div>
    <script>
      window.abtestGoalTracked = {};
      window.displaySearchFormHeader = false
      window.trackGoal = function trackGoal(goalName) {
        if (window.analytics) {
          if (window.debug_abtest_tracking) {
            console.log('Tracking goal: ', goalName);
          }
  ...
  <div id="restaurant_container" class="container">
    <div class="row">
      <div class="col-12">
        ...
        <div class="f75b57cb">
          <div class="_77744cb0">
            <h2 class="_050040ce _5ce7f008">Popular restaurants in <?php echo e($city); ?></h2>
            <span>
            </span>
          </div>
      ...
      <div class=" col-12 col-sm-6 col-md-4 col-lg-3">
        ...
        <div class="row">
          <div class="col-12 photo_holder">
            <img class="photo_image" border="0" alt="Restaurant Image: <?php echo e($d->name); ?>" src="<?php echo e($d->image_url); ?>" width="100" height="100">
          </div>
          <div class="col-12 r_text">

            <div class="_5e8d5397 _70be0f0d r_name"><?php echo e($d->name); ?></div>
            <div class="_5e8d5397 _70be0f0d"> <i><?php echo e($d->address); ?> </i></div>
            <div id="r_price">
              <?php for($i=0; $i < $d->price; $i++): ?>$
                <?php endfor; ?></div>
